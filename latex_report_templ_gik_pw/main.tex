...
\input{content/1-wstep.tex}        
\input{content/1.1-formatowanie_tekstu} 
\input{content/1.2-cytowania}
\input{content/1.3-wypunktowania}
\input{content/2-wzory} 
\input{content/2.1-rysunki}
\input{content/2.2-tabele}
\input{content/2.3-wstawianie_kodu}
\input{content/4-podsumowanie}
